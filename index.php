...
<div class="container"> 
  ...
  <header> <a href="">
    ...
    <div  style="position:relative; left:0px; top: 20px; width: 1000px;" >
     
       <a href="#hero" style="padding:25px;">LÄS TEXT</a>
       <a href="#about" style="padding:25px;">SKICKA TEXT</a>
     <a href="#about" style="padding:25px;">HUR FUNKAR DET?</a>
     <a href="#about" style="padding:25px;">VARFÖR REGINA?</a>
     <a href="#about" style="padding:25px;">LADDA NER APP</a>
      
    </div>
  </header>
  <!-- Hero Section -->
  <section class="about" style="background-color:#8bc34a" id="about">
  <div style="position:relative; left:0px; height:500px; top:0px;width:100%">
  <div style="position:absolute; left:0px; top: 0px;"></div>
  <div style="position:absolute; right:0px; top:0px;"><img src="pix/regina_android_iphone_apps.png" width="400" height="424" alt=""/></div>
